# Generated by Django 5.1.6 on 2025-03-27 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='Rider')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'User'), ('shopowner', 'Shop Owner'), ('rider', 'Rider')], default='normal', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True, null=True)),
                ('contact_number', models.CharField(blank=True, max_length=15, null=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='Sub_user/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='SubProfile/')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
